...
<section class="mx-auto max-w-measure bg-surface px-6 pt-20 pb-20 md:px-14">
	...
	<div class="stack-list flex flex-col gap-[30px]">
			...
			<div class="relative z-[1] self-center">
				...
				>
					...
					>
						...
						<rect width="460" height="400" fill="url(#proj-grid)"></rect>
						<text
							x="22"
							y="36"
							font-family="monospace"
		...
		<!-- Karte 05 ist der Abschluss des Stapels: der Kontakt-CTA schiebt sich
		     über Karte 04, statt als eigenes Band nach dem Sticky-Auslauf zu folgen.
		     Die äußere Fläche hat die volle Kartengröße und den Seitengrund, damit sie
		     Karte 04 komplett verdeckt; die dunkle Karte ist flacher als diese Fläche,
		     und der Creme-Streifen darüber trennt den CTA sichtbar vom Stapel. -->
		<div
			class="stack-card relative flex items-center justify-center rounded-card bg-surface py-10 md:min-h-[32rem]"
		>
			<ContactCard heading="h3" />
		</div>
	</div>
</section>
...
<style>
	...
	.stack-list {
		--stack-top: 96px;
		--stack-peek: 22px;
		/* Kein Auslauf-Padding nötig: Karte 05 (Kontakt) liefert selbst den
		   Scrollweg, auf dem Karte 04 pinnt und überdeckt wird. Die letzte Karte
		   muss nicht pinnen — über ihr stapelt nichts mehr. */
	}
	...
	.stack-list :global(.stack-card:nth-child(5)) {
		top: calc(var(--stack-top) + var(--stack-peek) * 4);
	}
